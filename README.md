...
* [Codehooks](https://codehooks.io) - A modern, lightweight serverless backend platform tailored for building data-powered APIs fast using JavaScript/TypeScript and NoSQL. Free plan.
